...
_Written at the close of **Session A** (artifacts), 2026-08-28. Overwrite this file at the
close of each session; archive the previous copy as `<NN>-<step>.md` in this directory._
